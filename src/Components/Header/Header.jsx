    ...
    <section className="flex bg-rgb  h-52 ">
      ...
      <section className="w-3/4 flex flex-col items-end mr-28 justify-center">
        <section className="flex m-4 relative">
          ...
          <input
            className="   outline-transparent appearance-none w-80 h-8 border border-2 rounded-lg bg-rgb input-search text-white"
            type="text"
            placeholder=""
          ></input>
          <i className="text-white cursor-pointer flex items-center justify-center right-2 absolute top-2 ">
            <FaSearch />
          </i>
        </section>
        <section className="flex justify-center items-center my-4">
          ...
          <button className="  py-3 text-lg px-8 bg-white text-red-600 font-bold rounded-xl hover:bg-red-600 hover:text-white hover:scale-105 transition duration-200 transform  ease-in " onClick={handleButton} >
            DONATE
